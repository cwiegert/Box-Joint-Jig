#include <Nextion.h>
  ...
  NexText     tSawStop    =    NexText        (0, 44, "tSawStop");        //  Text box to hold the front limit of the sled.  INstead of bouncing against limit switch
  NexButton   bSledStop   =    NexButton      (0, 43, "bsledStop");       //  button to set the front limit of the sled.
  NexButton   bUp         =    NexButton      (0, 39, "bUp");             //  Button to move sled towards the saw
  NexButton   bDown       =    NexButton      (0, 40, "bDown");           //  Button to move sled away from saw
  NexButton   bLeft       =    NexButton      (0, 42, "bLeft");           //  Button to move carriage to the left
  NexButton   bRight      =    NexButton      (0, 41, "bRight");          //  Button to move carriage to the right
